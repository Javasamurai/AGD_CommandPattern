...
namespace Command.Player
{
    public class PlayerService
    {
        ...
        public void PerformAction(Actions.CommandType actionSelected, UnitController targetUnit)
        {
