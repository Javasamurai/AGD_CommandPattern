...
namespace Command.UI
{
    public class ActionSelectionUIController : IUIController
    {
        ...
        public void Show(List<Actions.CommandType> executableCommands)
        {
            ResetActionButtons();
        ...
        private void CreateActionButtons(List<Actions.CommandType> executableCommands)
        {
            foreach(Actions.CommandType commandType in executableCommands)
            {
        ...
        public void OnActionSelected(Actions.CommandType actionType)
        {
